...
print('[EXECUTE] Starting V9 Optimized training...')
print('='*80)
...
class PipelineOptimized:
    ...
    def step3(self, data):
        print('\n' + '='*80 + '\n[STEP 3/6] INDICATORS + ENHANCED FEATURES\n' + '='*80)
        d = data.copy()
        ...
        print('[INFO] Enhanced Volatility Features')
    ...
    def step6a(self, Xt, Xv, Xte, yvt, yvv, yvte):
        ...
        m.save_model('volatility_model_v9_optimized.json')
    ...
    def step7(self):
        ...
        rd = {'timestamp': datetime.now().isoformat(), 'pair': 'BTCUSDT', 'timeframe': '1h', 
              'version': 'v9_optimized', 'models': self.results, 
              'note': 'Volatility: Optimized XGBoost (proven method), Price: LSTM'}
        with open('v9_results_optimized.json', 'w') as f:
    ...
    def run(self):
        ...
        self.step7()
        print('\n' + '='*80)
        print('V9 OPTIMIZED TRAINING COMPLETED')
        print('='*80)
