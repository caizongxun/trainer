...
class Pipeline:
    ...
    def step7(self):
        print('\n' + '='*80 + '\n[STEP 7/6] SAVE\n' + '='*80)
        rd = {'timestamp': datetime.now().isoformat(), 'pair': 'BTCUSDT', 'timeframe': '1h', 'version': 'v9', 'models': self.results, 'note': 'Direction derived from Price_t+10 vs Price_current'}
